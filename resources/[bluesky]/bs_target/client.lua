CreateThread(function()	
	...
	JobCheck = function(job)
		if job == 'all' or job == _character.Job.job then
			return true
		end
		return false
	end
	...
	CitizenCheck = function(citizenid)
		return citizenid == exports['bs_base']:FetchComponent('Player').LocalPlayer:GetData('Character'):GetData('ID')
	end
	...
	RegisterNetEvent('Characters:Client:Updated', function(JobInfo)
