...
AddEventHandler("phone:call:in-progress", function(pNumber, pCallId, pPayphone)
  ...
  --exports['pnp-voice']:addPlayerToCall(pCallId)
end)
...
AddEventHandler("phone:call:inactive", function(pNumber, callId, bool)
  ...
  --exports['pnp-voice']:removePlayerFromCall(callId)
end)
...
-- answer from phone
RegisterNUICallback("pnp-ui:callAccept", function(data, cb)
...
-- dial from phone
RegisterNUICallback("pnp-ui:callStart", function(data, cb)
...
-- end from phone
RegisterNUICallback("pnp-ui:callEnd", function(data, cb)
    local call_id = data.callId
...
-- init
Citizen.CreateThread(function()
    exports["pnp-binds"]:registerKeyMapping("","Phone", "Call Answer", "+answerPhoneCall", "-answerPhoneCall")
    RegisterCommand('+answerPhoneCall', answerPhoneCall, false)
    RegisterCommand('-answerPhoneCall', function() end, false)
    exports["pnp-binds"]:registerKeyMapping("","Phone", "Call End", "+endPhoneCall", "-endPhoneCall")
