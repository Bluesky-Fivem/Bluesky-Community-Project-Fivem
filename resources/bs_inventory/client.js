...
RegisterNetEvent('Characters:Client:Inventory');
on('Characters:Client:Inventory', async (broughtData) => {
    console.log(broughtData)
    cid = broughtData.citizenId
    cash = broughtData.cash
...
on('inventory-open-request', async () => {
    ...
    let vehicleFound = IsModelAVehicle(GetEntityModel())
