...
RegisterNUICallback("pnp-ui:genericNotificationResponse", function(data, cb)
...
function DoPhoneConfirmation(pTimeOut, pTitle, pText, pIcon, pBgColor, pCallback)
    ...
    SendReactMessage('setNotify', {
        ...
        data = {
            ...
            onAccept = "pnp-ui:genericNotificationResponse",
            onReject = "pnp-ui:genericNotificationResponse",
