        ...
        <div class="voting-container" style="height: {VoteSent ? 25 : 86 }vh">
            ...
            {#if VoteSent}
                <div style="width: calc(100% - 2vh); top: 50%; transform: translateY(-50%); position: absolute;">
                    <p style="text-align: center; font-family: Roboto; font-size: 1.5vh; color: white;">YOUR VOTE OPTIONS HAVE BEEN SAVED</p>
                    <p style="text-align: center; font-family: Roboto; font-size: 2.5vh; color: white; ">THANK YOU FOR VOTING!</p>
                </div>
            {:else}
                ...
                <div style="display: flex; justify-content: space-between">
                    ...
                    <p style="margin-top: 1.3vh; color: white; font-family: Roboto; font-size: 1.2vh;">{$Ballots[$CurrentBallot].MultipleChoice ? "SELECT AT LEAST ONE" : "SELECT YOUR CHOICE"}</p>
                </div>
                ...
                <div style="width: 100%;">
                    {#if $CurrentBallot > 0}
                        <Button style="float: left" Color="warning" on:click={() => { CurrentBallot.set($CurrentBallot - 1) }}>Previous Voting</Button>
                    {/if}
