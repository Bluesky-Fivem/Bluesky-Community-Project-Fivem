            ...
            for k, v in pairs(Eye.PedEntries) do
                if v.Entity == nil and #(Pos - vector3(v.Position.x, v.Position.y, v.Position.z)) < 50.0 then
                    ...
                    if v.Anim and next(v.Anim) ~= nil then
                        RequestAnimationDict(v.Anim.Dict)
...
function RegisterKeybinds()
    Keybinds.AddKeybind("eyePeek", "Spelers", "Peek", "LMENU", function(IsPressed)
        if IsPressed then
...
exports("AddOptionToPeek", function(Name, Data)
    ...
    exports['bs-ui']:RemoveOptionFromPeek(Name, Data.Name)
...
-- Events
-- RegisterNetEvent('bs-ui:Client:UiReset', function()
...
--[[
-- Ped
exports['bs-ui']:AddEyeEntry("ped_1", {
    Type = 'Entity',
    EntityType = 'Ped',
    SpriteDistance = 10.0,
    State = false,
    ...
    Options = {
        {
            ...
            EventType = 'Client',
            EventName = 'bs-ui:Client:EyeTest',
            EventParams = {},
...
exports['bs-ui']:AddEyeEntry("object_1", {
    Type = 'Entity',
...
-- Zone
exports['bs-ui']:AddEyeEntry("zone_1", {
    Type = 'Zone',
    SpriteDistance = 10.0,
    Distance = 5.0,
    State = false,
...
exports['bs-ui']:AddEyeEntry(GetHashKey("prop_bin_05a"), {
    Type = 'Model',
    Model = 'prop_bin_05a',
    SpriteDistance = 10.0,
    Distance = 5.0,
