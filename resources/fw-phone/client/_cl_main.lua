...
function RegisterKeybinds()
    Keybinds.AddKeybind("openMobile", "Phone", "Open", "M", OpenPhone)
    Keybinds.AddKeybind("phoneAnwser", "Phone", "Open", "Answer", function(IsPressed)
    ...
    Keybinds:AddKeybind("phoneDecline", "Phone", "Hangup", "", function(IsPressed)
        if not IsPressed then return end
...
function OpenPhone(IsPressed, IsBurner)
   -- if not IsPressed then return end
    ...
    local PlayerData = exports['bs_base']:FetchComponent('Player').LocalPlayer:GetData('Character')
