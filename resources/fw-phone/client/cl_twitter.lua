...
function InitTwitter()
    local Posts = Callbacks:ServerCallback("fw-phone:Server:Twitter:GetTweets")
...
RegisterNUICallback("Twitter/PostTweet", function(Data, Cb)
    local Result = Callbacks:ServerCallback("fw-phone:Server:Twitter:PostTweet", Data)
    Cb("Ok")
end)

RegisterNUICallback("Twitter/ReportTweet", function(Data, Cb)
    local Result = Callbacks:ServerCallback("fw-phone:Server:Twitter:ReportTweet", Data)
    Cb("Ok")
end)
