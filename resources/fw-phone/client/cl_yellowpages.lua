...
function InitYellowPages()
    local Posts = Callbacks:ServerCallback("fw-phone:Server:YellowPages:GetPosts")
...
RegisterNUICallback("YellowPages/PostAd", function(Data, Cb)
    local Result = Callbacks:ServerCallback("fw-phone:Server:YellowPages:PostAd", Data)
    Cb("Ok")
end)

RegisterNUICallback("YellowPages/RemoveAd", function(Data, Cb)
    local Result = Callbacks:ServerCallback("fw-phone:Server:YellowPages:RemoveAd", Data)
    Cb("Ok")
end)
